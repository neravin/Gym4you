...
class PricesControllerTest < ActionController::TestCase
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post :create, price: { number_months: @price.number_months, price: @price.price, terms: @price.terms }
    end
  ...
  test "should update price" do
    patch :update, id: @price, price: { number_months: @price.number_months, price: @price.price, terms: @price.terms }
    assert_redirected_to price_path(assigns(:price))
  end
